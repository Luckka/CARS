                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  ...
                                  child: CarsWidget(
                                    ...
                                    valor: widget
                                        .homeBloc.listOffCars[index].valor,
                                    combustivel: widget.homeBloc
                                        .listOffCars[index].combustivel,
                                    onTap: () {
                                      showDialog(
                                          context: context,
                                                        ...
                                                        InkWell(
                                                          onTap: () {
                                                            if (_key
                                                              ...
                                                              ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Sucesso ao comprar item')));
                                                            }
                                                          },
                                                          child: Container(
                                                            height: 50,
